...
//			}
		    ...
		    //  System.out.println(Arrays.deepToString(thisState.Puzzle) + ": " + Integer.toString(thisState.Cost) );
	...
	{
		 if (aState.currentDirection == direction.Left) 
		 {
			 aState.Parent.Left = false;
		 }
		 
		 if (aState.currentDirection == direction.Right)
		 {
			 aState.Parent.Right = false;
		 }
		 
		 if (aState.currentDirection == direction.Up)
		 {
			 aState.Parent.Up = false;
		 }
		 if (aState.currentDirection == direction.Down)
		 {
